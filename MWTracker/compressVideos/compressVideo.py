...
def selectVideoReader(video_file):
    ...
    if isHDF5video:
        ...
        # TODO: this currently requires just the first image file. make it so that one can supply a path to multiple folders, and run compression on the files inside in parallel
        video_dir = os.path.split(video_file)[0]
