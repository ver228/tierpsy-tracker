...
import os
import sys
from fluorescence.TiffCapture.tiffcapture import tiffcapture as tc
...
def selectVideoReader(video_file):
    ...
    isTIFstack = video_file.endswith('.tif');
    ...
    if isHDF5video:
        ...
        vid = tc.opentiff(video_file);
        im_height = vid.shape[1];
        im_width = vid.shape[0];
