...
#define __PYX_HAVE__curvspace
#define __PYX_HAVE_API__curvspace
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'curvspace' */
__PYX_EXTERN_C DL_IMPORT(double) c_curvspace(double *, int, int, int, double *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "curvspace"
int __pyx_module_is_main_curvspace = 0;

/* Implementation of 'curvspace' */
...
static const char __pyx_k_curv_len[] = "curv_len";
static const char __pyx_k_curvspace[] = "curvspace";
...
static const char __pyx_k_C_Users_Avelino_Avelino_VM_Docum[] = "C:\\Users\\Avelino.Avelino_VM\\Documents\\GitHub\\Multiworm_Tracking\\MWTracker\\analysis\\ske_create\\segWormPython\\cythonFiles\\curvspace.pyx";
...
static PyObject *__pyx_n_s_curv_len;
static PyObject *__pyx_n_s_curvspace;
...
static PyObject *__pyx_pf_9curvspace_curvspace(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_points, int __pyx_v_N); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_9curvspace_1curvspace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_9curvspace_curvspace[] = "\n    multiply (arr, value)\n\n    Takes a numpy arry as input, and multiplies each elemetn by value, in place\n\n    param: array -- a 2-d numpy array of np.float64\n    param: value -- a number that will be multiplied by each element in the array\n\n    ";
static PyMethodDef __pyx_mdef_9curvspace_1curvspace = {"curvspace", (PyCFunction)__pyx_pw_9curvspace_1curvspace, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9curvspace_curvspace};
static PyObject *__pyx_pw_9curvspace_1curvspace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_points = 0;
  int __pyx_v_N;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("curvspace (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_points,&__pyx_n_s_N,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("curvspace", 1, 2, 2, 1); __PYX_ERR(0, 28, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "curvspace") < 0)) __PYX_ERR(0, 28, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("curvspace", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 28, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("curvspace.curvspace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_points), __pyx_ptype_5numpy_ndarray, 0, "points", 0))) __PYX_ERR(0, 28, __pyx_L1_error)
  __pyx_r = __pyx_pf_9curvspace_curvspace(__pyx_self, __pyx_v_points, __pyx_v_N);
...
static PyObject *__pyx_pf_9curvspace_curvspace(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_points, int __pyx_v_N) {
  int __pyx_v_p_size;
  int __pyx_v_p_dim;
  PyObject *__pyx_v_curv_len = 0;
  ...
  __Pyx_RefNannySetupContext("curvspace", 0);
  ...
  __pyx_pybuffernd_points.rcbuffer = &__pyx_pybuffer_points;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_points.rcbuffer->pybuffer, (PyObject*)__pyx_v_points, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 28, __pyx_L1_error)
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  __pyx_t_7 = (__pyx_v_points->dimensions[0]);
  __pyx_t_8 = (__pyx_v_points->dimensions[1]);
  __pyx_v_p_size = __pyx_t_7;
  __pyx_v_p_dim = __pyx_t_8;
 ...
 */
  ...
  __pyx_t_11 = 0;
  __pyx_t_12 = 0;
  __pyx_t_1 = PyFloat_FromDouble(c_curvspace((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_points.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_points.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_points.diminfo[1].strides))), __pyx_v_p_size, __pyx_v_p_dim, __pyx_v_N, (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_output.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_output.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_output.diminfo[1].strides))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_curv_len = __pyx_t_1;
  __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_curv_len);
  __Pyx_GIVEREF(__pyx_v_curv_len);
  PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_v_curv_len);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_points.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_curv_len);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_curv_len, __pyx_k_curv_len, sizeof(__pyx_k_curv_len), 0, 0, 1, 1},
  {&__pyx_n_s_curvspace, __pyx_k_curvspace, sizeof(__pyx_k_curvspace), 0, 0, 1, 1},
 ...
 *     multiply (arr, value)
 */
  __pyx_tuple__10 = PyTuple_Pack(6, __pyx_n_s_points, __pyx_n_s_N, __pyx_n_s_p_size, __pyx_n_s_p_dim, __pyx_n_s_curv_len, __pyx_n_s_output); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_Avelino_Avelino_VM_Docum, __pyx_n_s_curvspace, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcurvspace(void); /*proto*/
PyMODINIT_FUNC initcurvspace(void)
#else
PyMODINIT_FUNC PyInit_curvspace(void); /*proto*/
PyMODINIT_FUNC PyInit_curvspace(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_curvspace(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("curvspace", __pyx_methods, __pyx_k_Created_on_Wed_May_27_00_43_07, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_curvspace) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "curvspace")) {
      if (unlikely(PyDict_SetItemString(modules, "curvspace", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     multiply (arr, value)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9curvspace_1curvspace, NULL, __pyx_n_s_curvspace); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_curvspace, __pyx_t_1) < 0) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init curvspace", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init curvspace");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
