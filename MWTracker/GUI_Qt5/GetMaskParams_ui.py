...
class Ui_GetMaskParams(object):
    ...
    def retranslateUi(self, GetMaskParams):
        ...
        self.checkBox_hasTimestamp.setText(_translate("GetMaskParams", "has time stamp?"))
        self.label_6.setText(_translate("GetMaskParams", "Dilation"))
        self.label_skelSeg.setText(_translate("GetMaskParams", "Skeleton Segments"))
        self.label_fps.setText(_translate("GetMaskParams", "FPS"))
