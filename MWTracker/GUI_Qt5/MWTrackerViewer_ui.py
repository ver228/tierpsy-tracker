...
class Ui_MWTrackerViewer(object):
    def setupUi(self, MWTrackerViewer):
        ...
        MWTrackerViewer.resize(1233, 1292)
        ...
        spacerItem = QtWidgets.QSpacerItem(10, 1000, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
    ...
    def retranslateUi(self, MWTrackerViewer):
        ...
        self.pushButton_feats.setText(_translate("MWTrackerViewer", "Calc Individual Feat"))
