...
from MWTracker.GUI_Qt5.AnalysisProgress_ui import Ui_AnalysisProgress
from MWTracker.helperFunctions.runMultiCMD import GUI_CLEAR_SIGNAL
...
if __name__ == '__main__':
    from MWTracker.batchProcessing.trackSingleWorker import checkpoint
