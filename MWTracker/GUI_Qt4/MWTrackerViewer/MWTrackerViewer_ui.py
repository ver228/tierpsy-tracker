...
class Ui_ImageViewer(object):
    def setupUi(self, ImageViewer):
        ...
        spacerItem = QtGui.QSpacerItem(600, 20, QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem1 = QtGui.QSpacerItem(10, 1000, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
    ...
    def retranslateUi(self, ImageViewer):
        ...
        self.pushButton_join.setText(_translate("ImageViewer", "Join Trajectory", None))
        self.pushButton_split.setText(_translate("ImageViewer", "Split Trajectory", None))
        ...
        self.pushButton_W.setText(_translate("ImageViewer", "Single Worms", None))
        self.pushButton_WS.setText(_translate("ImageViewer", "Worm Cluster", None))
        ...
        self.checkBox_showLabel.setText(_translate("ImageViewer", "Show Labels", None))
        self.pushButton_ROI1_RW.setText(_translate("ImageViewer", "<<", None))
        self.comboBox_labelType.setItemText(0, _translate("ImageViewer", "Manual", None))
        self.comboBox_labelType.setItemText(1, _translate("ImageViewer", "Auto", None))
        self.pushButton_feats.setText(_translate("ImageViewer", "Calc Individual Feat", None))
