...
static const char __pyx_k_Users_ajaver_Documents_GitHub_M[] = "/Users/ajaver/Documents/GitHub/Multiworm_Tracking/MWTracker/trackWorms/segWormPython/cythonFiles/curvspace.pyx";
 ...
 *     multiply (arr, value)
 */
  __pyx_tuple__7 = PyTuple_Pack(6, __pyx_n_s_points, __pyx_n_s_N, __pyx_n_s_p_size, __pyx_n_s_p_dim, __pyx_n_s_curv_len, __pyx_n_s_output); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ajaver_Documents_GitHub_M, __pyx_n_s_curvspace, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
