...
track_parser = argparse.ArgumentParser(
...
track_parser.add_argument(
    '--results_dir_root',
    default=track_dflt_vals['results_dir_root'],
...
track_parser.add_argument(
    '--videos_list',
    default=track_dflt_vals['videos_list'],
...
def trackMultipleFilesFun(
    ...
    if not no_prev_check:
        print('Files to be proccesed : %i' %
              len(ctf.filtered_files['SOURCE_GOOD']))
        print('Invalid source files: %i' %
              len(ctf.filtered_files['SOURCE_BAD']))
        print('Files that were succesfully finished: %i' %
              len(ctf.filtered_files['FINISHED_GOOD']))
        print('Invalid finished files: %i' %
              len(ctf.filtered_files['FINISHED_BAD']))
