...
trajectories_list = [
    '/Users/ajaver/Desktop/Gecko_compressed/Features_Mask_short_CaptureTest_90pc_Ch2_18022015_230213.hdf5',
...
#%%
coord = [(row['coord_x'], row['coord_y'], row['frame_number'], row['worm_index_joined'])
         for row in feature_table.where('frame_number <45000 and worm_index_joined != -1')]
