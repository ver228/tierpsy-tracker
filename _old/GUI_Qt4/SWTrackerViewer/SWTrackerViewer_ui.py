...
class Ui_ImageViewer(object):
    ...
    def setupUi(self, ImageViewer):
        ...
        self.label_skelBlock = QtGui.QLabel(self.centralWidget)
        sizePolicy = QtGui.QSizePolicy(
        ...
        self.label_skelBlock.setObjectName(_fromUtf8("label_skelBlock"))
        self.horizontalLayout_6.addWidget(self.label_skelBlock)
        self.spinBox_skelBlock = QtGui.QSpinBox(self.centralWidget)
        sizePolicy = QtGui.QSizePolicy(
            QtGui.QSizePolicy.Maximum,
        ...
        self.spinBox_skelBlock.setObjectName(_fromUtf8("spinBox_skelBlock"))
    ...
    def retranslateUi(self, ImageViewer):
        ...
        self.label_skelBlock.setText(_translate("ImageViewer", "Block", None))
