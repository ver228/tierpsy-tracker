...
class getMaskParams_GUI(QMainWindow):
        ...
        if video_file:
            ...
            if os.path.exists(self.video_file):
                ...
                if 'Worm_Videos' in self.videos_dir:
                    ...
                    self.mask_files_dir = os.path.join(
                        self.videos_dir, 'MaskedVideos')
    ...
    def read_json(self):
        if not self.json_file:
            ...
            self.mask_param['resampling_N'] = param.skeletons_param[
                'resampling_N']
            self.mask_param['compression_buff'] = param.compress_vid_param[
                'buffer_size']
