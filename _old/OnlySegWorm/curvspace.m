...
for k = 1:N-1
   ...
   while isempty(newpt)
      ...
      %fprintf('%1.1f, %1.1f | %1.1f, %1.1f ] %1.1f\n',...
      %    ptnow(1), ptnow(2), pttarget(1), pttarget(2), remainder);
...
%disp(norm(pt2 - pt1));
%disp(dirvec)
%fprintf('%1.1f] %1.1f, %1.1f | %1.1f, %1.1f ] %1.1f | %1.1f, %1.1f\n',...
%          norm(dirvec), pt1(1), pt1(2), pt2(1), pt2(2), intv, newpt(1), newpt(2));
