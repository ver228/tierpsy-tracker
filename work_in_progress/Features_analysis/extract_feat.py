...
def getValidIndexes(skel_file, min_num_skel = 100, bad_seg_thresh = 0.9, min_valid_disp = 5):
    ...
    with pd.HDFStore(skel_file, 'r') as table_fid:
        ...
        good_skel_row = trajectories_data.loc[good_row, 'skeleton_id']
...
if __name__ == '__main__':
    ...
    for skel_file in glob.glob(main_dir + '*skeletons*')[1:]:
