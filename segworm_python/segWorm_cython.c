...
static char __pyx_k_Users_ajaver_GitHub_repositorie[] = "/Users/ajaver/GitHub_repositories/Multiworm_Tracking/work_on_progress/port_segworm/segWorm_cython.pyx";
 ...
 *     %CIRCCOMPUTECHAINCODELENGTHS Compute the chain-code length, at each point,
 */
  __pyx_tuple__7 = PyTuple_Pack(8, __pyx_n_s_points, __pyx_n_s_number_of_points, __pyx_n_s_sqrt2, __pyx_n_s_lastIndex, __pyx_n_s_dPx, __pyx_n_s_dPy, __pyx_n_s_lengths, __pyx_n_s_i); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ajaver_GitHub_repositorie, __pyx_n_s_circComputeChainCodeLengths, 33, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     //   Inputs:
 */
  __pyx_tuple__9 = PyTuple_Pack(25, __pyx_n_s_points, __pyx_n_s_edgeLength, __pyx_n_s_chainCodeLengths, __pyx_n_s_number_of_points, __pyx_n_s_last_index, __pyx_n_s_last_length, __pyx_n_s_angles, __pyx_n_s_edge1, __pyx_n_s_edge2, __pyx_n_s_pv_ind, __pyx_n_s_p1_ind, __pyx_n_s_p2_ind, __pyx_n_s_pv_length, __pyx_n_s_p, __pyx_n_s_pv, __pyx_n_s_nextP1_ind, __pyx_n_s_prevP2_ind, __pyx_n_s_delta_edge1, __pyx_n_s_delta_edge2, __pyx_n_s_nextE1, __pyx_n_s_p1, __pyx_n_s_p2, __pyx_n_s_a1, __pyx_n_s_a2, __pyx_n_s_angle); if (unlikely(!__pyx_tuple__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(3, 0, 25, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ajaver_GitHub_repositorie, __pyx_n_s_circCurvature_old, 144, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
