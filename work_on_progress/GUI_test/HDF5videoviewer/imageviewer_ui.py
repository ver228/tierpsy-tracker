...
#
# Created: Tue Jul 28 16:12:24 2015
...
class Ui_ImageViewer(object):
    def setupUi(self, ImageViewer):
        ...
        self.gridLayout.addWidget(self.pushButton_join, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_worm, 1, 3, 1, 1)
        self.pushButton_wormS = QtWidgets.QPushButton(self.centralWidget)
        self.pushButton_wormS.setObjectName("pushButton_wormS")
        self.gridLayout.addWidget(self.pushButton_wormS, 1, 4, 1, 1)
        self.pushButton_bad = QtWidgets.QPushButton(self.centralWidget)
        self.pushButton_bad.setObjectName("pushButton_bad")
        self.gridLayout.addWidget(self.pushButton_bad, 1, 5, 1, 1)
    ...
    def retranslateUi(self, ImageViewer):
        ...
        self.pushButton_worm.setText(_translate("ImageViewer", "Single Worm"))
        self.pushButton_wormS.setText(_translate("ImageViewer", "Worm Cluster"))
