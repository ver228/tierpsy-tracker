...
df_good = df_good.groupby('worm_index')['area'].aggregate(['mean', 'count'])
...
tracks_data = df_good[['worm_index', 'frame_number', 'coord_x', 'coord_y', 'area', 'major_axis', 'intensity_mean', 'speed']].groupby('worm_index').aggregate(['mean', 'max', 'min', 'first', 'last'])
#%%
