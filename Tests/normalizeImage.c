...
#define __PYX_HAVE__normalizeImage
#define __PYX_HAVE_API__normalizeImage
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'normalizeImage' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t = { "uint8_t", NULL, sizeof(__pyx_t_5numpy_uint8_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_uint8_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_uint8_t), 0 };
#define __Pyx_MODULE_NAME "normalizeImage"
int __pyx_module_is_main_normalizeImage = 0;
...
static const char __pyx_k_pix_val[] = "pix_val";
static const char __pyx_k_getMaxMin[] = "getMaxMin";
static const char __pyx_k_image_ori[] = "image_ori";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_image_norm[] = "image_norm";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_normalizeImage[] = "normalizeImage";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Created_on_Thu_Jul_21_17_56_10[] = "\nCreated on Thu Jul 21 17:56:10 2016\n\n@author: ajaver\n";
static const char __pyx_k_Users_ajaver_Documents_GitHub_M[] = "/Users/ajaver/Documents/GitHub/Multiworm_Tracking/Tests/normalizeImage.pyx";
...
static PyObject *__pyx_n_s_getMaxMin;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_image;
static PyObject *__pyx_n_s_image_norm;
static PyObject *__pyx_n_s_image_ori;
...
static PyObject *__pyx_n_s_pix_val;
...
static PyObject *__pyx_pf_14normalizeImage_getMaxMin(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_image); /* proto */
static PyObject *__pyx_pf_14normalizeImage_2normalizeImage(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image_ori); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_14normalizeImage_1getMaxMin(PyObject *__pyx_self, PyObject *__pyx_v_image); /*proto*/
static PyMethodDef __pyx_mdef_14normalizeImage_1getMaxMin = {"getMaxMin", (PyCFunction)__pyx_pw_14normalizeImage_1getMaxMin, METH_O, 0};
static PyObject *__pyx_pw_14normalizeImage_1getMaxMin(PyObject *__pyx_self, PyObject *__pyx_v_image) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getMaxMin (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_image), __pyx_ptype_5numpy_ndarray, 1, "image", 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  __pyx_r = __pyx_pf_14normalizeImage_getMaxMin(__pyx_self, ((PyArrayObject *)__pyx_v_image));
...
static PyObject *__pyx_pf_14normalizeImage_getMaxMin(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_image) {
  double __pyx_v_amax;
  double __pyx_v_amin;
  double __pyx_v_pix_val;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __Pyx_RefNannySetupContext("getMaxMin", 0);
  ...
  __pyx_pybuffernd_image.rcbuffer = &__pyx_pybuffer_image;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image.rcbuffer->pybuffer, (PyObject*)__pyx_v_image, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_v_amax = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_image.diminfo[1].strides));

  /* "normalizeImage.pyx":19
 * def getMaxMin(np.ndarray[np.float64_t, ndim=2] image):
 *     cdef double amax = image[0,0];
 *     cdef double amin = image[0,0];             # <<<<<<<<<<<<<<
 *     cdef double pix_val;
 ...
 */
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_v_amin = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_image.diminfo[1].strides));

  /* "normalizeImage.pyx":23
 *     cdef int i, j;
 * 
 ...
 *             pix_val = image[i,j]
 */
  __pyx_t_5 = (__pyx_v_image->dimensions[0]);
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_i = __pyx_t_6;

    /* "normalizeImage.pyx":24
 * 
 *     for i in range(image.shape[0]):
 *         for j in range(image.shape[1]):             # <<<<<<<<<<<<<<
 *             pix_val = image[i,j]
 ...
 */
      ...
      __pyx_v_pix_val = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_image.diminfo[1].strides));

      /* "normalizeImage.pyx":26
 *         for j in range(image.shape[1]):
 *             pix_val = image[i,j]
 *             if pix_val > amax:             # <<<<<<<<<<<<<<
 *                 amax = pix_val
 *             elif pix_val < amin:
 */
      __pyx_t_11 = ((__pyx_v_pix_val > __pyx_v_amax) != 0);
      if (__pyx_t_11) {

        /* "normalizeImage.pyx":27
 *             pix_val = image[i,j]
 *             if pix_val > amax:
 *                 amax = pix_val             # <<<<<<<<<<<<<<
 *             elif pix_val < amin:
 ...
 * 
 */
      __pyx_t_11 = ((__pyx_v_pix_val < __pyx_v_amin) != 0);
      if (__pyx_t_11) {

        /* "normalizeImage.pyx":29
 *                 amax = pix_val
 *             elif pix_val < amin:
 *                 amin = pix_val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_12 = PyFloat_FromDouble(__pyx_v_amin); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = PyFloat_FromDouble(__pyx_v_amax); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("normalizeImage.getMaxMin", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_14normalizeImage_3normalizeImage(PyObject *__pyx_self, PyObject *__pyx_v_image_ori); /*proto*/
static PyMethodDef __pyx_mdef_14normalizeImage_3normalizeImage = {"normalizeImage", (PyCFunction)__pyx_pw_14normalizeImage_3normalizeImage, METH_O, 0};
static PyObject *__pyx_pw_14normalizeImage_3normalizeImage(PyObject *__pyx_self, PyObject *__pyx_v_image_ori) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("normalizeImage (wrapper)", 0);
  __pyx_r = __pyx_pf_14normalizeImage_2normalizeImage(__pyx_self, ((PyObject *)__pyx_v_image_ori));
...
static PyObject *__pyx_pf_14normalizeImage_2normalizeImage(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image_ori) {
  PyArrayObject *__pyx_v_image = 0;
  int __pyx_v_i;
  double __pyx_v_amin;
  double __pyx_v_amax;
  double __pyx_v_factor;
  PyArrayObject *__pyx_v_image_norm = 0;
  npy_intp __pyx_v_j;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_image;
  __Pyx_Buffer __pyx_pybuffer_image;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_image_norm;
  __Pyx_Buffer __pyx_pybuffer_image_norm;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_image.data = NULL;
  __pyx_pybuffernd_image.rcbuffer = &__pyx_pybuffer_image;
  __pyx_pybuffer_image_norm.pybuffer.buf = NULL;
  __pyx_pybuffer_image_norm.refcount = 0;
  __pyx_pybuffernd_image_norm.data = NULL;
  __pyx_pybuffernd_image_norm.rcbuffer = &__pyx_pybuffer_image_norm;

  /* "normalizeImage.pyx":38
 * @cython.cdivision(True)
 * def normalizeImage(image_ori):
 *     cdef np.ndarray[np.float64_t, ndim=2] image = image_ori.astype(np.float64)             # <<<<<<<<<<<<<<
 * 
 *     cdef int i;
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_image_ori, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_image_ori, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_uint8); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image_norm.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_image_norm = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 43, __pyx_L1_error)
    } else {__pyx_pybuffernd_image_norm.diminfo[0].strides = __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_image_norm.diminfo[0].shape = __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_image_norm.diminfo[1].strides = __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_image_norm.diminfo[1].shape = __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_7 = 0;
  __pyx_v_image_norm = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "normalizeImage.pyx":46
 *         np.zeros(image_ori.shape, dtype=np.uint8);
 * 
 *     amin, amax = getMaxMin(image)             # <<<<<<<<<<<<<<
 ...
 *     for i in range(image.shape[0]):
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_getMaxMin); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = NULL;
  ...
  if (!__pyx_t_5) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_1, ((PyObject *)__pyx_v_image)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
  } else {
  ...
  if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
    ...
    Py_ssize_t index = -1;
    __pyx_t_5 = PyObject_GetIter(__pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_2);
    if (__Pyx_IternextUnpackEndCheck(__pyx_t_8(__pyx_t_5), 2) < 0) __PYX_ERR(0, 46, __pyx_L1_error)
    __pyx_t_8 = NULL;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_amin = __pyx_t_9;
  __pyx_v_amax = __pyx_t_10;

  /* "normalizeImage.pyx":47
 * 
 *     amin, amax = getMaxMin(image)
 *     factor = 255/(amax-amin);             # <<<<<<<<<<<<<<
 *     for i in range(image.shape[0]):
 *         for j in range(image.shape[1]):
 */
  __pyx_v_factor = (255.0 / (__pyx_v_amax - __pyx_v_amin));

  /* "normalizeImage.pyx":48
 *     amin, amax = getMaxMin(image)
 *     factor = 255/(amax-amin);
 *     for i in range(image.shape[0]):             # <<<<<<<<<<<<<<
 *         for j in range(image.shape[1]):
 ...
 */
  __pyx_t_11 = (__pyx_v_image->dimensions[0]);
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
    __pyx_v_i = __pyx_t_12;

    /* "normalizeImage.pyx":49
 *     factor = 255/(amax-amin);
 *     for i in range(image.shape[0]):
 *         for j in range(image.shape[1]):             # <<<<<<<<<<<<<<
 *             image_norm[i,j] = <char>((image[i,j]-amin)*factor);
 * 
 */
    __pyx_t_13 = (__pyx_v_image->dimensions[1]);
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      __pyx_v_j = __pyx_t_14;

      /* "normalizeImage.pyx":50
 *     for i in range(image.shape[0]):
 *         for j in range(image.shape[1]):
 *             image_norm[i,j] = <char>((image[i,j]-amin)*factor);             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_image_norm.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_image_norm.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_image_norm.diminfo[1].strides) = ((char)(((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_image.diminfo[1].strides)) - __pyx_v_amin) * __pyx_v_factor));
    }
  }

  /* "normalizeImage.pyx":52
 *             image_norm[i,j] = <char>((image[i,j]-amin)*factor);
 * 
 *     return image_norm, (amin, amax)             # <<<<<<<<<<<<<<
 * 
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_amin); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_amax); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(((PyObject *)__pyx_v_image_norm));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_image_norm));
  PyTuple_SET_ITEM(__pyx_t_2, 0, ((PyObject *)__pyx_v_image_norm));
  __Pyx_GIVEREF(__pyx_t_1);
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_ErrFetch(&__pyx_type, &__pyx_value, &__pyx_tb);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image_norm.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("normalizeImage.normalizeImage", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image.rcbuffer->pybuffer);
  ...
  __Pyx_XDECREF((PyObject *)__pyx_v_image_norm);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "normalizeImage",
    __pyx_k_Created_on_Thu_Jul_21_17_56_10, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_getMaxMin, __pyx_k_getMaxMin, sizeof(__pyx_k_getMaxMin), 0, 0, 1, 1},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_image, __pyx_k_image, sizeof(__pyx_k_image), 0, 0, 1, 1},
  {&__pyx_n_s_image_norm, __pyx_k_image_norm, sizeof(__pyx_k_image_norm), 0, 0, 1, 1},
  {&__pyx_n_s_image_ori, __pyx_k_image_ori, sizeof(__pyx_k_image_ori), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pix_val, __pyx_k_pix_val, sizeof(__pyx_k_pix_val), 0, 0, 1, 1},
 ...
 *     cdef double amin = image[0,0];
 */
  __pyx_tuple__7 = PyTuple_Pack(6, __pyx_n_s_image, __pyx_n_s_amax, __pyx_n_s_amin, __pyx_n_s_pix_val, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(1, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ajaver_Documents_GitHub_M, __pyx_n_s_getMaxMin, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__9 = PyTuple_Pack(8, __pyx_n_s_image_ori, __pyx_n_s_image, __pyx_n_s_i, __pyx_n_s_amin, __pyx_n_s_amax, __pyx_n_s_factor, __pyx_n_s_image_norm, __pyx_n_s_j); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ajaver_Documents_GitHub_M, __pyx_n_s_normalizeImage, 37, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initnormalizeImage(void); /*proto*/
PyMODINIT_FUNC initnormalizeImage(void)
#else
PyMODINIT_FUNC PyInit_normalizeImage(void); /*proto*/
PyMODINIT_FUNC PyInit_normalizeImage(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_normalizeImage(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("normalizeImage", __pyx_methods, __pyx_k_Created_on_Thu_Jul_21_17_56_10, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_normalizeImage) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "normalizeImage")) {
      if (unlikely(PyDict_SetItemString(modules, "normalizeImage", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef double amin = image[0,0];
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14normalizeImage_1getMaxMin, NULL, __pyx_n_s_normalizeImage); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_getMaxMin, __pyx_t_1) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14normalizeImage_3normalizeImage, NULL, __pyx_n_s_normalizeImage); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_normalizeImage, __pyx_t_1) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "normalizeImage.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * """
 * Created on Thu Jul 21 17:56:10 2016
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init normalizeImage", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init normalizeImage");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
