...
class Ui_BatchProcessing(object):
    def setupUi(self, BatchProcessing):
        ...
        self.gridLayout_3.addWidget(self.p_is_copy_video, 1, 0, 1, 2)
        self.p_analysis_sequence = QtWidgets.QComboBox(self.centralwidget)
        self.p_analysis_sequence.setObjectName("p_analysis_sequence")
        self.gridLayout_3.addWidget(self.p_analysis_sequence, 1, 3, 1, 1)
    ...
    def retranslateUi(self, BatchProcessing):
        ...
        self.p_is_copy_video.setText(_translate("BatchProcessing", "Copy original videos to tmp dir"))
        self.label.setText(_translate("BatchProcessing", "Sequence to be Processed"))
