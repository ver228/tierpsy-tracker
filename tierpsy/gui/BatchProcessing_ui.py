...
class Ui_BatchProcessing(object):
    def setupUi(self, BatchProcessing):
        ...
        self.comboBox_paramFile = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_paramFile.setEditable(True)
        self.comboBox_paramFile.setObjectName("comboBox_paramFile")
        self.gridLayout_2.addWidget(self.comboBox_paramFile, 4, 2, 1, 1)
