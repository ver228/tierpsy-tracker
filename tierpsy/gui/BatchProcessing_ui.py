...
class Ui_BatchProcessing(object):
    def setupUi(self, BatchProcessing):
        ...
        self.gridLayout_3.addWidget(self.p_force_start_point, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.p_end_point, 5, 2, 1, 1)
        self.p_only_summary = QtWidgets.QCheckBox(self.centralwidget)
        self.p_only_summary.setObjectName("p_only_summary")
        self.gridLayout_3.addWidget(self.p_only_summary, 0, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.p_unmet_requirements, 1, 3, 1, 1)
