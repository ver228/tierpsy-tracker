...
class Ui_Summarizer(object):
    def setupUi(self, Summarizer):
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.TimeWindows)
        ...
        self.horizontalLayout.addWidget(self.p_time_windows)
        ...
        self.p_time_units.addItem("")
        self.horizontalLayout.addWidget(self.p_time_units)
