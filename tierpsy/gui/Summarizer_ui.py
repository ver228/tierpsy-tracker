...
class Ui_Summarizer(object):
    def setupUi(self, Summarizer):
        ...
        self.p_feat_set = QtWidgets.QComboBox(self.TimeWindows)
        self.p_feat_set.setObjectName("p_feat_set")
        self.gridLayout_3.addWidget(self.p_feat_set, 1, 3, 1, 1)
        ...
        self.p_keywords_include = QtWidgets.QLineEdit(self.widget)
        ...
        self.p_keywords_exclude = QtWidgets.QLineEdit(self.widget)
...
" to sample"))
        self.label_7.setText(_translate("Summarizer", "Selected features"))
        ...
        self.label_10.setText(_translate("Summarizer", "Select features by keywords (optional) :"))
