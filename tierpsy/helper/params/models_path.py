...
if not os.path.exists(DFLT_MODEL_FILTER_WORMS):
    warnings.warn('The default model file to filter spurious particles was not found. This step will not be done.')
...
if not os.path.exists(DFLT_MODEL_FOOD_CONTOUR):
    warnings.warn('The default model to obtain the food contour was not found. I would try a less accurate algorithm to calculate the contour.')
